...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/jqiHpe5Ja9)
...
```sh
npx nx serve cashfinity-landing-page
```

To create a production bundle:

```sh
npx nx build cashfinity-landing-page
```

To see all available targets to run for a project, run:

```sh
npx nx show project cashfinity-landing-page
```
